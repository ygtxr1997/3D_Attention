...
__all__ = ['seresnet18', 'seresnet34', 'seresnet50', 'seresnet101']
...
def _seresnet(arch, block, layers, **kwargs):
    model = SEResNet(block, layers, **kwargs)
    return model


def seresnet18(**kwargs):
    return _seresnet('seresnet18', BasicResidualSEBlock, [2, 2, 2, 2],
                     **kwargs)


def seresnet34(**kwargs):
    return _seresnet('seresnet34', BasicResidualSEBlock, [3, 4, 6, 3],
                     **kwargs)


def seresnet50(**kwargs):
    return _seresnet('seresnet50', BottleneckResidualSEBlock, [3, 4, 6, 3],
                     **kwargs)


def seresnet101(**kwargs):
    return _seresnet('seresnet101', BottleneckResidualSEBlock, [3, 4, 23, 3],
                     **kwargs)


def seresnet152(**kwargs):
    return _seresnet('seresnet152', BottleneckResidualSEBlock, [3, 8, 36, 3],
                     **kwargs)
